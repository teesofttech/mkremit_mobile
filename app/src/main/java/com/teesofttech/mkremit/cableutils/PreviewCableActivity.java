...
import com.teesofttech.mkremit.electricityutils.ElectricityCompletionActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnWallet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                JsonObjectRequest jsonObjReq = new JsonObjectRequest(
                        Request.Method.POST, Constant.VENDING_CABLE_COMPLETE_BY_WALLET, params,
                            ...
                            public void onResponse(JSONObject response) {
                                ...
                                try {
                                    ...
                                    if (statusCode.equals("200")) {
                                        ...
                                        Intent ii = new Intent(PreviewCableActivity.this, CableCompleteActivity.class);
                                        ...
                                        alertDialogManager.showAlertDialog(PreviewCableActivity.this, "Failed", "" + content.getString("message"), false);
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if (error instanceof ServerError && response != null) {
                            try {
                                ...
                                Toast.makeText(PreviewCableActivity.this, obj.getString("message"), Toast.LENGTH_LONG).show();
        ...
        btnCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new RaveUiManager(PreviewCableActivity.this).setAmount(Double.parseDouble(amnt.toString()))
                        .setCurrency("NGN")
        ...
        if (requestCode == RaveConstants.RAVE_REQUEST_CODE && data != null) {
            ...
            if (resultCode == RavePayActivity.RESULT_SUCCESS) {
                ...
                try {
                    ...
                    String vendingComplete = Constant.VENDING_CABLE_COMPLETE + "/" + vendingCode.getText().toString();
                    Log.d("Test", vendingComplete);
                    JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
                        ...
                        @Override
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(PreviewCableActivity.this, "Error occurred while vending", Toast.LENGTH_LONG).show();
                            VolleyLog.d("TAGGG", "Error: " + error.getMessage());
                            // As of f605da3 the following should work
                            waitingDialog.dismiss();
                            NetworkResponse response = error.networkResponse;

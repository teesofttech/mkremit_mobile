...
public class PreviewEducationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preview_education);
        ...
        UserModel model = PrefUtils.getCurrentUser(PreviewEducationActivity.this);
        ACProgressFlower dialog = new ACProgressFlower.Builder(PreviewEducationActivity.this)
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if (error instanceof ServerError && response != null) {
                            try {
                                ...
                                Toast.makeText(PreviewEducationActivity.this, obj.getString("message"), Toast.LENGTH_LONG).show();
            ...
            if (resultCode == RavePayActivity.RESULT_SUCCESS) {
                ...
                try {
                    ...
                    JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
                        ...
                        @Override
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(PreviewEducationActivity.this, "Error occurred while vending", Toast.LENGTH_LONG).show();
                            VolleyLog.d("TAGGG", "Error: " + error.getMessage());
                            // As of f605da3 the following should work
                            waitingDialog.dismiss();
                            NetworkResponse response = error.networkResponse;

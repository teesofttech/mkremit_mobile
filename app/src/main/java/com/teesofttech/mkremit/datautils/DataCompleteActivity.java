...
public class DataCompleteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txttitle.setText("V E N D I N G  COMPLETED");
        ...
        UserModel model = PrefUtils.getCurrentUser(DataCompleteActivity.this);
        ACProgressFlower dialog = new ACProgressFlower.Builder(DataCompleteActivity.this)

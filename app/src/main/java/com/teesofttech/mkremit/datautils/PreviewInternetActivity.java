...
public class PreviewInternetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        service.setText(ii.getStringExtra("variationCode"));
        ...
        UserModel model = PrefUtils.getCurrentUser(PreviewInternetActivity.this);
        ACProgressFlower dialog = new ACProgressFlower.Builder(PreviewInternetActivity.this)
                            ...
                            public void onResponse(JSONObject response) {
                                ...
                                try {
                                    ...
                                    if (statusCode.equals("200")) {
                                        ...
                                        Intent ii = new Intent(PreviewInternetActivity.this, AirtimeCompletionActivity.class);
                                        ...
                                        alertDialogManager.showAlertDialog(PreviewInternetActivity.this, "Failed", "Opps!!! Wrong username and password supplied", false);
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if (error instanceof ServerError && response != null) {
                            try {
                                ...
                                Toast.makeText(PreviewInternetActivity.this, obj.getString("message"), Toast.LENGTH_LONG).show();
        ...
        btnCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new RaveUiManager(PreviewInternetActivity.this).setAmount(Double.parseDouble(Amount.getText().toString()))
                        .setCurrency("NGN")
            ...
            if (resultCode == RavePayActivity.RESULT_SUCCESS) {
                ...
                try {
                    ...
                    JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
                        ...
                        @Override
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(PreviewInternetActivity.this, "Error occurred while vending", Toast.LENGTH_LONG).show();
                            VolleyLog.d("TAGGG", "Error: " + error.getMessage());
                            // As of f605da3 the following should work
                            waitingDialog.dismiss();
                            NetworkResponse response = error.networkResponse;

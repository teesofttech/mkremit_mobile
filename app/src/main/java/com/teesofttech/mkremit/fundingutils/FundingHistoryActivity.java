...
import com.teesofttech.mkremit.adapter.HistoryListAdapter;
...
public class FundingHistoryActivity extends AppCompatActivity {
    private static final String TAG = FundingHistoryActivity.class.getSimpleName();
    private RecyclerView recyclerView;
    private ArrayList<Funding> cartList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_funding_history);
        ...
        txttitle.setText("WALLET FUNDING HISTORY");
        ...
        model = PrefUtils.getCurrentUser(FundingHistoryActivity.this);
        if (model == null) {
            startActivity(new Intent(FundingHistoryActivity.this, LoginActivity.class));
            finish();
        } else {
            progressDialog = new ProgressDialog(FundingHistoryActivity.this);
            progressDialog.setMessage("Please wait while we load transactions.");
            progressDialog.setCancelable(false);

            recyclerView = findViewById(R.id.recycle_view);
            cartList = new ArrayList<>();
            mAdapter = new HistoryListAdapter(this, cartList);
            ...
            String url = Constant.GETWALLETHISTORY + "/" + model.getId();
            fetchDealer(url);
